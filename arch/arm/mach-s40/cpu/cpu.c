...
extern struct cpu_info hi3796cv100_cpu_info;
...
static long long get_chipid_reg(void)
{
	...
	chipid = (long long)readl((volatile void*)(IO_ADDRESS(REG_BASE_SCTL + REG_SC_SYSID0)));
	val = (long long)readl((volatile void*)(IO_ADDRESS(REG_BASE_PERI_CTRL + REG_PERI_SOC_FUSE)));
