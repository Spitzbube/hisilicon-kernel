#ifndef __DRV_DISP_ALG_CSC_H__
#define __DRV_DISP_ALG_CSC_H__
...
HI_VOID DISP_ALG_CscCoefSet(ALG_CSC_DRV_PARA_S *pstCscDrvPara, ALG_CSC_RTL_PARA_S *pstCscRtlPara);


#endif /*__DRV_DISP_ALG_CSC_H__*/
