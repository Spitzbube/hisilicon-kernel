...
*/
#ifndef __HIFB_SCROLLTEXT_H__
#define __HIFB_SCROLLTEXT_H__
...
typedef struct 
{
    HI_BOOL bAvailable;            /*the scrolltext layer is available or not*/
    HI_U32  u32textnum;     
	HI_U32  u32ScrollTextId;         /**the ID allocated for the scrolltext that will be created */
