...
typedef union
{
    struct
    {
        ...
        HI_U32  pvr_hcken           : 1;    // [8]
        HI_U32  dmx_cken            : 1;    // [9]
        HI_U32  reserved1           : 1;    // [10]
        HI_U32  tsi0_cken           : 1;    // [11]
        HI_U32  tsi1_cken           : 1;    // [12]
        HI_U32  tsi2_cken           : 1;    // [13]
        HI_U32  pvr_tsout_cken      : 1;    // [14]
        HI_U32  reserved2           : 1;    // [15]
        HI_U32  tsi0_inclk_pctrl    : 1;    // [16]
        HI_U32  tsi1_inclk_pctrl    : 1;    // [17]
...
#else 
#define SWITCH_CFG                      (0x3A00)    /* input stream switch register */
#endif
...
#else
// Define the union U_SWITCH_CFG
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    switch_cfg1           : 3   ; // [2..0]
        unsigned int    Reserved_7            : 1   ; // [3]
        unsigned int    switch_cfg2           : 3   ; // [6..4]
        unsigned int    Reserved_6            : 1   ; // [7]
        unsigned int    switch_cfg3           : 3   ; // [10..8]
        unsigned int    Reserved_5            : 1   ; // [11]
        unsigned int    switch_cfg4           : 3   ; // [14..12]
        unsigned int    Reserved_4            : 1   ; // [15]
        unsigned int    switch_cfg5           : 3   ; // [18..16]
        unsigned int    Reserved_3            : 1   ; // [19]
        unsigned int    switch_cfg6           : 3   ; // [22..20]
        unsigned int    Reserved_2            : 1   ; // [23]
        unsigned int    switch_cfg7           : 3   ; // [26..24]
...
// Define the union U_CW_SET
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    cw_word_id            : 2   ; // [1..0]
        unsigned int    Reserved_1            : 6   ; // [7..2]
        unsigned int    cw_odd_even           : 1   ; // [8]
        unsigned int    cw_group_id           : 5   ; // [13..9]
        unsigned int    Reserved_0            : 18  ; // [31..14]
    } bits;
...
#define TS_CNT0_L(ScdId)                (0xC1B0 + ((ScdId) << 3))   /* TS packet counter 0 of joining on someone record buffer low 32bit */
#define TS_CNT0_H(ScdId)                (0xC1B4 + ((ScdId) << 3))   /* TS packet counter 0 of joining on someone record buffer high 8 bits */
...
typedef union
{
    ...
    struct
    {
        unsigned int    iint_desc_i           : 2   ; // [1..0]
...
typedef union
{
    ...
    struct
    {
        unsigned int    iena_desc_i           : 2   ; // [1..0]
