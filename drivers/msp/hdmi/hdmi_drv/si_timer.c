...
static HI_U8 OldOutputState = 0xFF;            /*HDMI last output state note*//*CNcomment:HDMI��һ�����״̬���� */
HI_U8 OutputState    = CABLE_UNPLUG_;   /*HDMI output state at the present time*//*CNcomment: HDMI��ǰ���״̬ */
...
/*CNcomment:
 ...
 (1)~(2):ΪHPD�û�����Ӧ���
 (2)~(3):ΪHPD�ں˲�HDCP��Ȩ���
 ��䶼�ᱻ�Ȳ�����ϣ���Ҫ���ǲ�ͬ�Ĺ�̵ĸ�λ������   
 ������Ҫ����ļ��������������̡�
*/
HI_U32 HPDIsrCount            = 0;      /*the timer of HPD interrupt*//*CNcomment:HPD�жϲ���ļ����� */
HI_U32 HPDKernelCallbackCount = 0;      /*the timer of the HPD kernel level Callback*//*CNcomment: HPD Kernel level Callback�������Ӧ��HDP�ļ����� */
HI_U32 HPDUserCallbackCount   = 0;      /*the timer of the HPD user level Callback*//*CNcomment: HPD User level Callback�������Ӧ��HDP�ļ����� */
HI_U32 HPDAuthCount           = 0;      /*the timer of the HPD authentication*//*CNcomment:HPD HDCP Auth������ʹ�õ�HDP�ļ����� */

static HI_U8 OldAuthState   = 0xFF;     /*the HDCP last state of authorization*//*CNcomment: HDCP��Ȩ��һ��״̬���� */
HI_U8 AuthState      = NO_HDCP;         /*the HDCP current state of authorization*//*CNcomment:HDCP��Ȩ��ǰ״̬ */
...
static void SI_Check_OutputStatus(void)
{
    if(HI_TRUE == SI_HPD_Status())
    {
        ...
        {
           /*HDMI init ,there isn't HPD event*/ /*CNcomment:HDMI��ʼ������ǰû�а취����HPD!*/
