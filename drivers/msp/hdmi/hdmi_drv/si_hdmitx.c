...
void SI_WakeUpHDMITX(void)
{
    ...
    //x6��֮ǰ�汾0x08Ĭ��ֵ 0x34,S40 Ĭ��ֵ0x37.��̫ȷ����ʲô�ģ��Ⱥ�����汾����һ��
...
void SI_SetHdmiAudio(HI_U8 Enabled)
{
    ...
    else
    {
        ...
        WriteByteHDMITXP0(TX_SWRST_ADDR, 0x02);
    }
}
...
void SI_Init_DVITX(void)
{
    ...
    RegVal = ReadByteHDMITXP1(DIAG_PD_ADDR);
    HI_INFO_HDMI ("Power Up internal oscillator.\n");
#endif
...
//  the manual settings.
//
// Throughout the code, calls to "HDMI_DEBUG" send strings to the "Debugger" window of HDMIGear. That
...
//      Data is written to the Debugger window by calling HDMI_DEBUG().
//
