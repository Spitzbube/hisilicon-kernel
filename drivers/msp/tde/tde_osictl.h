...
* Description:   use as vo register setting interface which  TDE triger signal synchronously
* Input:         TDE_TRIG_SEL: callback function pointer of triger signal setting
* Output:        none
* Return:        success / error code
* Others:        none
*****************************************************************************/
