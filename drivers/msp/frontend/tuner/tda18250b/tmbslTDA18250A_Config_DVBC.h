...
#define TDA18250A_DVBC_SETTINGS_MINOR_VER         (12)                     /* SW Settings Minor Version   */
...
#define TDA18250A_CONFIG_STD_QAM_6MHZ_VCO_PULLING_MINUS \
    ...
    TDA18250A_HPFOffset_min_12pc,                                            /* HPF Offset */          \
    TDA18250A_IF_Notch_Enabled,                                         /* IF notch */            \
    TDA18250A_IF_Notch_Freq_6_25MHz,                                    /* IF Notch Freq */       \
    TDA18250A_IF_Notch_Offset_plus_12pc,                                      /* IF Notch Offset */     \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_VCO_PULLING_MINUS \
    ...
    /****************************************************************/							  \
    TDA18250A_LPF_8MHz,													/* LPF */				  \
    TDA18250A_LPFOffset_plus_12pc,										/* LPF_Offset */		  \
    TDA18250A_DC_Notch_IF_PPF_Disabled,                                 /* DC notch IF PPF */     \
    TDA18250A_HPF_1MHz,                                               /* Hi Pass */			  \
    TDA18250A_HPFOffset_0pc,											/* HPF Offset */		  \
    TDA18250A_IF_Notch_Enabled,                                         /* IF notch */			  \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_VCO_PULLING_PLUS \
    ...
    /* Standard Preset Definitions: */
#define TDA18250A_CONFIG_STD_QAM_6MHZ_64QAM_VCO_PULLING_MINUS \
    {                                                                        /* QAM 6MHz */            \
    /****************************************************************/                            \
    /* IF Settings                                                  */                            \
    /****************************************************************/                            \
    ...
    TDA18250A_IF_Output_Level_0_85Vpp_min_7_5_22_5dB,                          /* IF Output Level */     \
    {                                                                   /* S2D Gain */            \
        {                                                                                         \
            (UInt32)0,                                                                                    \
            TDA18250A_S2D_Gain_6dB                                                                \
...
#define TDA18250A_CONFIG_STD_QAM_6MHZ_64QAM_VCO_PULLING_PLUS \
    {                                                                        /* QAM 6MHz */            \
    /****************************************************************/                            \
    /* IF Settings                                                  */                            \
    /****************************************************************/                            \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_64QAM_VCO_PULLING_MINUS \
    {																		/* QAM 8MHz */			  \
    /****************************************************************/							  \
    /* IF Settings                                                  */							  \
    /****************************************************************/							  \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_64QAM_VCO_PULLING_PLUS \
    {																		/* QAM 8MHz */			  \
    /****************************************************************/							  \
    /* IF Settings                                                  */							  \
    /****************************************************************/							  \
    ...
    /* Standard Preset Definitions: */
#define TDA18250A_CONFIG_STD_QAM_6MHZ_256QAM_VCO_PULLING_MINUS \
    {                                                                        /* QAM 6MHz */            \
    /****************************************************************/                            \
    /* IF Settings                                                  */                            \
    /****************************************************************/                            \
...
#define TDA18250A_CONFIG_STD_QAM_6MHZ_256QAM_VCO_PULLING_PLUS \
    {                                                                        /* QAM 6MHz */            \
    /****************************************************************/                            \
    /* IF Settings                                                  */                            \
    /****************************************************************/                            \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_256QAM_VCO_PULLING_MINUS \
    {																		/* QAM 8MHz */			  \
    /****************************************************************/							  \
    /* IF Settings                                                  */							  \
    /****************************************************************/							  \
...
#define TDA18250A_CONFIG_STD_QAM_8MHZ_256QAM_VCO_PULLING_PLUS \
    {																		/* QAM 8MHz */			  \
    /****************************************************************/							  \
    /* IF Settings                                                  */							  \
    /****************************************************************/							  \
