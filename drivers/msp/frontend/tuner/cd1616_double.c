...
static HI_S32 cd1616_double_write(HI_U32 u32TunerPort,HI_U8 enI2cChannel, HI_U8* pu8Data, HI_U32 u32Num)
{
    HI_U8 i;
    HI_S32 s32Ret;
    TUNER_I2C_DATA_S stI2cDataStr;
    HI_U8 au8SendData[6];
    HI_U8 u8NBytes = CD1616_TUNER_PARA_NUM;
...
HI_S32 cd1616_double_set_tuner(HI_U32 u32TunerPort, HI_U8 enI2cChannel, HI_U32 u32PuRF)
{
    HI_U32 u32FreqPll;
	HI_U32 u32RfProg;
    ...
    cd1616_double_write(u32TunerPort, enI2cChannel, au8TunerPara, CD1616_TUNER_PARA_NUM);
    return HI_SUCCESS;
}
