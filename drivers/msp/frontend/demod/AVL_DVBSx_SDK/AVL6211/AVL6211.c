...
HI_S32 avl6211_set_sat_attr(HI_U32 u32TunerPort, HI_UNF_TUNER_SAT_ATTR_S *pstSatTunerAttr)
{
    ...
    pstParam->stConfig.enTSClockPolarity = pstAttr->enTSClkPolar;
    pstParam->stConfig.enTSFormat = pstAttr->enTSFormat;
    pstParam->stConfig.enSerDataPin = pstAttr->enTSSerialPIN;
    ...
    pstParam->stConfig.enTunerIQSpectrumMode = pstAttr->enIQSpectrum;
    pstParam->stConfig.enWaveMode = (enum AVL_DVBSx_Diseqc_WaveFormMode)pstAttr->enDiSEqCWave;
...
static void ChannelFilter(HI_UNF_TUNER_SAT_TPINFO_S *pstTPValidList, HI_U8 *pu8ValidNum,
