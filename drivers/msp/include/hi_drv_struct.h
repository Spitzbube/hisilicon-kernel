...
#define HI_MOD_ADE                 "ade"
#define UMAP_DEVNAME_ADE           UMAP_NAME HI_MOD_ADE
#define UMAP_DEV_NUM_ADE           2
#define UMAP_MIN_MINOR_ADE         (UMAP_MAX_MINOR_AENC + 1)
#define UMAP_MAX_MINOR_ADE         (UMAP_MIN_MINOR_ADE + UMAP_DEV_NUM_ADE -1)

#define HI_MOD_ADSP                 "adsp"
#define UMAP_DEVNAME_ADSP           UMAP_NAME HI_MOD_ADSP
#define UMAP_DEV_NUM_ADSP           2
#define UMAP_MIN_MINOR_ADSP         (UMAP_MAX_MINOR_ADE + 1)
