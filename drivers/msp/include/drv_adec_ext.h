...
HI_S32			HI_DRV_ADEC_ReceiveFrame (HI_HANDLE hAdec, HI_UNF_AO_FRAMEINFO_S *pstAOFrame,
                                       ADEC_EXTFRAMEINFO_S *pstExtInfo);
HI_S32			HI_DRV_ADEC_ReleaseFrame(HI_HANDLE hAdec, const HI_UNF_AO_FRAMEINFO_S *pstAOFrame);
