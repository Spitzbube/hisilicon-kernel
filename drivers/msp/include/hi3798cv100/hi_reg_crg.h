...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_1            : 2   ; /* [11..10]  */
        unsigned int    dspclk_skipcfg        : 5   ; /* [16..12]  */
        unsigned int    dspclk_loaden         : 1   ; /* [17]  */
        unsigned int    reserved_0            : 14  ; /* [31..18]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    vicap_clk_sel         : 1   ; /* [9]  */
        unsigned int    vicap_clk_sel_vi      : 1   ; /* [10]  */
        unsigned int    reserved_0            : 21  ; /* [31..11]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    bit7                  : 3   ; /* [9..7]  */
        unsigned int    bit10                 : 3   ; /* [12..10]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_1            : 2   ; /* [11..10]  */
        unsigned int    hwcclk_skipcfg        : 5   ; /* [16..12]  */
        unsigned int    hwcclk_loaden         : 1   ; /* [17]  */
        unsigned int    reserved_0            : 14  ; /* [31..18]  */
    } bits;
...
typedef struct
{
    ...
    volatile unsigned int           reserved_1[2]            ; /* 0x38~0x3c */
    ...
    volatile unsigned int           reserved_2               ; /* 0x80 */
    ...
    volatile unsigned int           reserved_3               ; /* 0x98 */
    ...
    volatile unsigned int           reserved_4[2]            ; /* 0xb0~0xb4 */
    ...
    volatile unsigned int           reserved_5[2]            ; /* 0x104~0x108 */
    ...
    volatile unsigned int           reserved_8               ; /* 0x170 */
