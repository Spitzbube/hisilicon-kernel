...
typedef HI_S32 (* FN_WIN_SetSource)(HI_HANDLE hWin, HI_DRV_WIN_SRC_INFO_S *pstSrc);
typedef HI_S32 (* FN_WIN_GetSource)(HI_HANDLE hWin, HI_DRV_WIN_SRC_INFO_S *pstSrc);
