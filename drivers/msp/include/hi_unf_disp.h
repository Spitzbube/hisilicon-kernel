...
typedef enum hiUNF_DISP_VBI_TYPE_E
{
    ...
    HI_UNF_DISP_VBI_TYPE_CC,                        /**<closed caption type*//**<CNcomment: ������Ļ����*/
    HI_UNF_DISP_VBI_TYPE_VCHIP,                     /**<v-chip type*//**<CNcomment: v-chip����*/
...
{
    HI_UNF_ENC_FMT_E       enEncodingFormat;   /**<format of display device *//**<CNcomment:��ʾ�豸��ʽ*/
    HI_UNF_DISP_TIMING_S   stLcdPara;          /**<lcd para *//**<CNcomment:LCD����*/
    ...
    HI_BOOL                bGammaEnable;       /**<gamma *//**<CNcomment:٤��*/
    HI_UNF_DISP_BG_COLOR_S stBgColor;          /**<background clor *//**<CNcomment:����ɫ*/
    HI_VOID                *pRevData;          /**<reserved data *//**<CNcomment:�������*/
}HI_UNF_DISP_ATTR_S;
