...
typedef enum hiUNF_DISP_VBI_TYPE_E
{
    ...
    HI_UNF_DISP_VBI_TYPE_CC,                        /**<closed caption type*//**<CNcomment: 隐藏字幕类型*/
    HI_UNF_DISP_VBI_TYPE_VCHIP,                     /**<v-chip type*//**<CNcomment: v-chip类型*/
...
{
    HI_UNF_ENC_FMT_E       enEncodingFormat;   /**<format of display device *//**<CNcomment:显示设备制式*/
    HI_UNF_DISP_TIMING_S   stLcdPara;          /**<lcd para *//**<CNcomment:LCD参数*/
    ...
    HI_U32                 u32HuePlus;         /**<HuePlus *//**<CNcomment:色调*/
    HI_BOOL                bGammaEnable;       /**<gamma *//**<CNcomment:伽马*/
    HI_UNF_DISP_BG_COLOR_S stBgColor;          /**<background clor *//**<CNcomment:背景色*/
    HI_VOID                *pRevData;          /**<reserved data *//**<CNcomment:保留数据*/
}HI_UNF_DISP_ATTR_S;
