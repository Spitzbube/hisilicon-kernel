...
typedef enum hiUNF_HDMI_DEFAULT_ACTION_E
{
    ...
    HI_UNF_HDMI_DEFAULT_ACTION_HDMI, //1  /**<Default action HDMI*//**<CNcomment:�����ж�HDMI */
...
{
    HI_UNF_3D_FRAME_PACKETING                 = 0x00, /**<3d type:Frame Packing*//**<CNcomment:3d ģʽ:֡��װ*/
    HI_UNF_3D_FIELD_ALTERNATIVE               = 0x01, /**<3d type:Field alternative*//**<CNcomment:3d ģʽ:������*/
    HI_UNF_3D_LINE_ALTERNATIVE                = 0x02, /**<3d type:Line alternative*//**<CNcomment:3d ģʽ:�н���*/
    HI_UNF_3D_SIDE_BY_SIDE_FULL               = 0x03, /**<3d type:Side by side full*//**<CNcomment:3d ģʽ:����ʽ ����ȫ��*/
    HI_UNF_3D_L_DEPTH                         = 0x04, /**<3d type:L+depth*//**<CNcomment:3d ģʽ:L+DEPTH*/
...
typedef struct hiUNF_HDMI_CEC_STATUS_S
{
    ...
    HI_U8   u8LogicalAddr; //8                          /**<CEC logic address,defualt 0x03*//**<CNcomment:CEC �߼���ַ��Ĭ��Ϊ��0x03. */
