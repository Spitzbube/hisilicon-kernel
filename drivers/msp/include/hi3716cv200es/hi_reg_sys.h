...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    mcu_bus_clk_div       : 3   ; /* [6..4]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    mcu_master_mux        : 1   ; /* [2]  */
...
typedef struct
{
    ...
    volatile U_SC_DDRC_DFI_RST_CTRL   SC_DDRC_DFI_RST_CTRL   ; /* 0x54 */
    volatile U_SC_DDRPHY_LP_EN      SC_DDRPHY_LP_EN          ; /* 0x58 */
    volatile unsigned int           reserved_1               ; /* 0x5c */
    ...
    volatile unsigned int           reserved_2[5]            ; /* 0x6c~0x7c */
    ...
    volatile unsigned int           reserved_3[67]           ; /* 0x100~0x208 */
    volatile unsigned int           SC_LOCKEN                ; /* 0x20c */
    volatile unsigned int           reserved_4[820]          ; /* 0x210~0xedc */
