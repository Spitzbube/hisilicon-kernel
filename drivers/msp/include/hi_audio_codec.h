...
/**
 * Definition of the decoder output pts infomations. CNcomment:pts输出信息
 */
typedef struct hiHI_HA_OUTPTSINFO_S
{
    union {
        HI_U32 u32SwDecoderBytesLeft;
        HI_U32 u32HwDecoderPtsReadPos;
    }unPts;
} HI_HA_OUTPTSINFO_S;
...
typedef struct hiHI_HA_INPUTBUF_S
{
    HI_U32   u32BufPhyAddr;             /**<Output, buffer physical addr*/ /**<CNcomment: */ 
    HI_U32   u32BufVirAddr;             /**<Output, buffer virtual addr*/ /**<CNcomment: */ 
    HI_U32   u32BufSize;                /**<Input, buffer size*/ /**<CNcomment: */ 
    HI_U32   u32PtsBoundary;	        /**<Input, pts read pointers wrap*/ /**<CNcomment: */ 
} HI_HA_INPUTBUF_S;

typedef struct hiHI_HA_SYNC_INPUTBUF_WPOS_S
{
    HI_U32   u32StreamWritePos;         /**<Input, stream write position*/ /**<CNcomment: */ 
    HI_U32   u32WritePos;               /**<Input, buffer write position*/ /**<CNcomment: */ 
} HI_HA_SYNC_INPUTBUF_WPOS_S;

typedef struct hiHI_HA_SYNC_INPUTBUF_RPOS_S
{
    HI_U32   u32ReadPos;	            /**<Output, buffer read position*/ /**<CNcomment: */ 
} HI_HA_SYNC_INPUTBUF_RPOS_S;


typedef struct hiHI_HA_OUTPUTBUF_S
{
    HI_U32   u32BufPhyAddr;              /**<Output, buffer physical addr*/ /**<CNcomment: */ 
    HI_U32   u32BufVirAddr;              /**<Output, buffer virtual addr*/ /**<CNcomment: */ 
...
#ifdef HA_HW_CODEC_SUPPORT
    HI_HA_ERRORTYPE_E (*HwSetEnable)(HI_VOID * hDecoder, HI_BOOL bEnable);

    HI_HA_ERRORTYPE_E (*HwInbufInit)(HI_VOID * hDecoder,
                                              HI_HA_INPUTBUF_S *pstInBufAttr);

    HI_HA_ERRORTYPE_E (*HwInBufDeInit)(HI_VOID * hDecoder);

    HI_HA_ERRORTYPE_E (*HwInbufSyncWpos)(HI_VOID * hDecoder,
                                              HI_HA_SYNC_INPUTBUF_WPOS_S *pstSyncInBufWpos);    

    HI_HA_ERRORTYPE_E (*HwInbufSyncRpos)(HI_VOID * hDecoder,
                                              HI_HA_SYNC_INPUTBUF_RPOS_S *pstSyncInBufRpos);    

    HI_HA_ERRORTYPE_E (*HwInbufSetEosflag)(HI_VOID * hDecoder);

    HI_HA_ERRORTYPE_E (*HwOutbufInit)(HI_VOID * hDecoder,
                                              HI_HA_OUTPUTBUF_S *pstOutBufAttr);

    HI_HA_ERRORTYPE_E (*HwOutBufDeInit)(HI_VOID * hDecoder);

    HI_HA_ERRORTYPE_E (*HwReceiveFrame)(HI_VOID * hDecoder,
                                              HI_HADECODE_OUTPUT_S * pstAOut);

    HI_HA_ERRORTYPE_E (*HwReleaseFrame)(HI_VOID * hDecoder,
