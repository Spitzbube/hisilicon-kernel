...
typedef enum hiTDE2_COLOR_FMT_E
{
    ...
    TDE2_COLOR_FMT_YCbCr422, //35           /**<YUV packet422 format*//**<CNcomment:YUV packet422��ʽ */
...
typedef enum hiTDE2_MB_COLORFMT_E
{
    ...
    TDE2_MB_COLOR_FMT_MP1_YCbCr420MBP, //3   /**<Semi-planar YUV420 format*//**<CNcomment:Semi-planar YUV420��ʽ */
    ...
    TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP, //7   /**<Semi-planar YUV444 format, for JPG pictures*//**<CNcomment:Semi-planar YUV444��ʽ,����Ӧ��JPG */
...
typedef enum hiTDE2_CLIPMODE_E
{
    ...
    TDE2_CLIPMODE_INSIDE, //1  /**<Clip the data within the rectangle to output and discard others*//**<CNcomment:���о��η�Χ�ڵ�������,�����ӵ�*/
...
typedef enum hiTDE2_MBRESIZE_E
{
    ...
    TDE2_MBRESIZE_QUALITY_LOW, //1     /**<Low-quality scaling*//**<CNcomment:���������� */
    TDE2_MBRESIZE_QUALITY_MIDDLE, //2  /**<Medium-quality scaling*//**<CNcomment:���������� */
    TDE2_MBRESIZE_QUALITY_HIGH, //3    /**<High-quality scaling*//**<CNcomment:���������� */
    TDE2_MBRESIZE_BUTT
} TDE2_MBRESIZE_E;
...
typedef enum hiTDE2_COLORKEY_MODE_E
{
    ...
    TDE2_COLORKEY_MODE_FOREGROUND, //1  /**<When performing the colorkey operation on the foreground bitmap, you need to perform this operation before the CLUT for color extension and perform this operation after the CLUT for color correction.*//**<CNcomment:��ǰ��λͼ����color key��˵��:������ɫ��չ����CLUTǰ��color key��������ɫУ��:��CLUT����color key */
    TDE2_COLORKEY_MODE_BACKGROUND, //2  /**<Perform the colorkey operation on the background bitmap*//**<CNcomment:�Ա���λͼ����color key*/
...
typedef enum hiTDE2_OUTALPHA_FROM_E
{
    ...
    TDE2_OUTALPHA_FROM_BACKGROUND, //1 /**<Output from the background bitmap*//**<CNcomment:��Դ�ڱ���λͼ */
    TDE2_OUTALPHA_FROM_FOREGROUND, //2 /**<Output from the foreground bitmap*//**<CNcomment:��Դ��ǰ��λͼ */
    TDE2_OUTALPHA_FROM_GLOBALALPHA, //3 /**<Output from the global alpha*//**<CNcomment:��Դ��ȫ��alpha */
...
typedef enum hiTDE2_BLENDCMD_E
{
    ...
    TDE2_BLENDCMD_CONFIG, //14  /**<You can set the parameteres.*//**<CNcomment:�û��Լ����ò���*/
    TDE2_BLENDCMD_BUTT
}TDE2_BLENDCMD_E;
...
typedef struct hiTDE2_OPT_S
{
    ...
    TDE2_DEFLICKER_MODE_E enDeflickerMode; //68 /**<Anti-flicker mode*//**<CNcomment:����˸ģʽ*/

    HI_BOOL bResize; //72                       /**<Whether to scale*//**<CNcomment:�Ƿ�����*/
...
typedef struct hiTDE2_MBOPT_S
{
    ...
    TDE2_MBRESIZE_E enResize; //24      /**<Scaling information*//**<CNcomment:������Ϣ*/
